...
## 请求参数
Header 参数生成代码Acceptstring 必需默认值:application/jsonAuthorizationstring 必需默认值:sk-Content-Typestring 必需默认值:application/jsonBody 参数application/json生成代码modelstring 必需要使用的模型的 ID。有关哪些模型适用于聊天 API 的详细信息
