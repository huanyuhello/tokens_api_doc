...
![image-20260323115258129.png](../resource/635527.png)

3.
等待安装完成，左侧活动栏看到 Cline 图标
如下图所示：

![image-20260323115708898.png](../resource/635529.png)
...
2.
在 Model ID 中，可以选择或输入希望使用的模型名称，例如 gpt-5.2，然后保存完成。
注意
选择或输入的模型名称必须与平台模型广场中的模型名称保持一致，可以直接复制黏贴过来。

![image-20260323115418418.png](../resource/635533.png)
