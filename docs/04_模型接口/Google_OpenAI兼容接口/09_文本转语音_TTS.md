...
| `response_format` | string | 必需 | 默认为 mp3 音频的格式。支持的格式有:mp3、opus、aac 和 flac。 |
| `encoding_format` | string | 必需 | 默认为 1 生成的音频速度。选择0.25到4.0之间的值。1.0是默认值。 示例 |
